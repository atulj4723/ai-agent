...
export const searchParticularMemoryDescription = {
    ...
    description: "SECOND step. After finding a memory with 'search_memory_archives', use this tool with the 'summary_key' to retrieve the full, detailed conversation content.",
    parameters: {
        type: "object",
        properties: {
            query: {
                type: "string",
                description: "The summary_key of the memory you want to retrieve.The unique key for the archive file, e.g., 'summary-123456789.json'."
            }
        },
        required: ["query"]
    }
